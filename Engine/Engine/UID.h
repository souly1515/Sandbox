...
#define RegisterResource(BaseType, TypeName)\
...
#define GetResourceType(BaseType, TypeName)\
  uid_base<BaseType, Resource_##BaseType_##TypeName>

template <typename BaseType, typename ResourceName>
struct uid_base
{
  constexpr uid_base() = default;
  static constexpr uint32_t internalID = 0;
  static constexpr std::string_view resourceName = "";
private:
};
